...
//     if(user.profilePicture) formData.append
//     ('profilePicture', user.profilePicture);
//     if(user.coverPicture) formData.append
...
//           <div className="loginBox">
//             <form onSubmit={handleSubmit}>
//               <input type="text" name="username" value={user.username} onChange={handleInput} placeholder="Username" className="loginInput"/>

//               <input type="email" name="email" value={user.email} onChange={handleInput} placeholder="Email" className="loginInput"/>

//               <input type="password" name="password" value={user.password} onChange={handleInput} placeholder="Password" className="loginInput"/>

//               <input type="password" name="confirmPass" value={user.confirmPass} onChange={handleInput} placeholder="ConfirmPass" className="loginInput"/>

//               <input type="file" name="profilePicture" value={user.profilePicture} onChange={handleInput} placeholder="ProfilePicture" className="loginInput"/>  

//               <input type="file" name="coverPicture" value={user.coverPicture} onChange={handleInput} placeholder="CoverPicture" className="loginInput"/>
